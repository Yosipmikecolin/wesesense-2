...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-green-500 text-green-50 shadow hover:bg-green-900/80 dark:bg-green-50 dark:text-green-900 dark:hover:bg-green-50/80",
        warning:
          "border-transparent bg-yellow-500 text-yellow-50 shadow hover:bg-yellow-900/80 dark:bg-yellow-50 dark:text-yellow-900 dark:hover:bg-yellow-50/80",
        secondary:
